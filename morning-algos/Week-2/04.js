...
class BinarySearchTree {
    ...
    toArrPreorder(node = this.root, vals = []) {
        ...
        let leftCurrent=this.root;
        let rightCurrent=this.root;
        rightCurrent=rightCurrent.right;
        while(this.left!=null && this.right!=null){
            console.log("we've entered the while loop")
            vals.push(leftCurrent.left.data);
            vals.push(leftCurrent.right.data)
            vals.push(rightCurrent.left.data)
            vals.push(leftCurrent.right.data)
